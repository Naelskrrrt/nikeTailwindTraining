  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-grotesc text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((item, index) => (
            <div key={item.label}>
              <p className="text-4xl font-grotesc font-bold">{item.value}</p>
      ...
      <div className="flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-center bg-hero relative">
        <img
          src={bigShoeImg}
          alt="Shoe Collection"
          width={510}
